      ...
      child: ListView(
        children: [
          ...
          Container(
            ...
            child: FittedBox(
              child: FutureBuilder<RentCarModel>(
                future: _getRentCarFuture,
                builder: (context, snapshot) {
                  if(snapshot.connectionState == ConnectionState.waiting){
                    return Padding(padding: EdgeInsets.all(100), child: const LoadingWidget(title: "Vehicles loading"));
                    ...
                    return Padding(padding: EdgeInsets.all(50), child: DataError());
                  }
                }
              ),
            ),
